...
#[ORM\Entity(repositoryClass: MoneyOperationRepository::class)]
class MoneyOperation
{
    ...
    #[ORM\ManyToOne(inversedBy: 'moneyOperations')]
    ...
    public function setIsIncome(bool $is_income): static
    {
